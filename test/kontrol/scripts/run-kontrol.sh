...
if [ "$SCRIPT_TESTS" == true ]; then
    ...
    test_list=( "KontrolAllowedControllersTest.prove_setCollectionAllowance_invalid" \
                  "KontrolAllowedControllersTest.prove_setCollectionAllowance_valid" \
                  "KontrolAllowedControllersTest.prove_setDelegationControllerAllowances" \
                 DelegationWalletRegistryTest.prove_setFactory_onlyOwner \
                  DelegationWalletRegistryTest.prove_setFactory_should_work
              )
