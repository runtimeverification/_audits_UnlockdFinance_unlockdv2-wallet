...
interface IDelegationOwner {
    ...
    function transferAsset(address _asset, uint256 _assetId, address _receiver) external;
    ...
    function delegationId(address _asset, uint256 _assetId) external pure returns (bytes32);
}
